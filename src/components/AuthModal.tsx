  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[#18212b] rounded-[28px] shadow-[0_30px_90px_rgba(0,0,0,0.55)] w-full max-w-md overflow-hidden relative min-h-[400px] border border-white/10"
          ...
          {googleAuthStep === 'select' ? (
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-semibold text-white mb-2">Pilih akun</h2>
                <p className="text-slate-400 text-sm">untuk melanjutkan ke Kedai Prasmar</p>
              </div>

              <div className="space-y-2">
                <button onClick={selectGoogleAccount} className="w-full flex items-center p-3 hover:bg-white/10 rounded-xl transition-colors border border-transparent hover:border-white/10">
                  ...
                  <div className="text-left">
                    <div className="font-medium text-white text-sm">Budi Santoso</div>
                    <div className="text-xs text-slate-400">budi.santoso@gmail.com</div>
                  </div>
                </button>
                <button onClick={selectGoogleAccount} className="w-full flex items-center p-3 hover:bg-white/10 rounded-xl transition-colors border border-transparent hover:border-white/10">
                  <img src="https://api.dicebear.com/7.x/notionists/svg?seed=Siti" alt="Siti" className="w-10 h-10 rounded-full bg-amber-100 mr-4" />
                  <div className="text-left">
                    <div className="font-medium text-white text-sm">Siti Aminah</div>
                    <div className="text-xs text-slate-400">siti.aminah@gmail.com</div>
                  </div>
                </button>
            ...
            >
                ...
                {!isLogin && (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <input type="text" required className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-11 pr-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all" placeholder="Nama Anda" />
                    </div>
                  </motion.div>
                )}
                
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1.5 ml-1">Alamat Email</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                      <Mail size={18} />
                    </div>
                    <input type="email" required className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-11 pr-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all" placeholder="email@contoh.com" />
                  </div>
                </div>

                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1.5 ml-1">Kata Sandi</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                      <Lock size={18} />
                    </div>
                    <input type="password" required className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-11 pr-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all" placeholder="••••••••" />
                  </div>
                </div>
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[#18212b] text-slate-400">Atau masuk dengan</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4 mb-8">
                <button type="button" onClick={handleGoogleLogin} className="flex items-center justify-center py-2.5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-white/20 transition-all group">
                ...
                <button type="button" onClick={() => { login(); onClose(); }} className="flex items-center justify-center py-2.5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-white/20 transition-all group">
